        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm leading-relaxed mb-5">
              Your trusted platform for quality rooms in {[estate, city].filter(Boolean).join(", ")}.
              Comfortable, affordable, and conveniently located.
            </p>
              ...
              <div className="flex flex-wrap gap-2">
                {socialLinks.map(({ href, icon, label }) => (
                  <a
                    ...
                    rel="noreferrer"
                    aria-label={label}
                    className="w-9 h-9 rounded-lg bg-gray-800 hover:bg-blue-600 flex items-center justify-center text-gray-400 hover:text-white transition-colors"
                  >
                    {icon}
                  </a>
                ))}
